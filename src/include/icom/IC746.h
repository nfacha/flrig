...
public:
	...
	virtual unsigned long long get_vfoA(void);
	virtual void set_vfoA(unsigned long long f);
	virtual unsigned long long get_vfoB(void);
	virtual void set_vfoB(unsigned long long f);
