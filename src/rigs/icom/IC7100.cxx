...
static std::vector<std::string>IC7100modes_;
static const char *vIC7100modes_[] =
{
"LSB",    "USB",    "AM",   "CW", 
"RTTY",   "FM",    "WFM",   "CW-R",
...
static std::vector<std::string>IC7100_ssb_bws;
static const char *vIC7100_ssb_bws[] =
{
...
static std::vector<std::string>IC7100_am_bws;
static const char *vIC7100_am_bws[] =
{
...
static std::vector<std::string>IC7100_rtty_bws;
static const char *vIC7100_rtty_bws[] =
{
"50",    "100",  "150",  "200",  "250",  "300",  "350",  "400",  "450",  "500",
"600",   "700",  "800",  "900", "1000", "1100", "1200", "1300", "1400", "1500",
"1600", "1700", "1800", "1900", "2000", "2100", "2200", "2300", "2400", "2500",
...
static std::vector<std::string>IC7100_fixed_bws;
static const char *vIC7100_fixed_bws[] =
{ "FIXED" };
...
void RIG_IC7100::initialize()
{
	...
	VECTOR (IC7100modes_, vIC7100modes_);
	VECTOR (IC7100_ssb_bws, vIC7100_ssb_bws);
	VECTOR (IC7100_am_bws, vIC7100_am_bws);
	VECTOR (IC7100_rtty_bws, vIC7100_rtty_bws);
	VECTOR (IC7100_fixed_bws, vIC7100_fixed_bws);
...
int RIG_IC7100::get_modeA()
{
	...
	get_trace(4, "mode_filterA[", IC7100modes_[md].c_str(), "] = ", szfilter[A.filter-1].c_str());
...
int RIG_IC7100::get_modeB()
{
	...
	get_trace(4, "mode_filterB[", IC7100modes_[md].c_str(), "] = ", szfilter[A.filter-1].c_str());
...
std::vector<std::string>& RIG_IC7100::bwtable(int m)
{
	switch (m) {
		case AM7100: case AMD7100:
			return IC7100_am_bws;
			break;
		case DV7100:
		case FM7100: case WFM7100: case FMD7100:
			return IC7100_fixed_bws;
			break;
		case RTTY7100: case RTTYR7100:
			return IC7100_rtty_bws;
			break;
		case CW7100: case CWR7100:
		case USB7100: case LSB7100: case USBD7100: case LSBD7100:
		default:
			return IC7100_ssb_bws;
	}
	return IC7100_ssb_bws;
}
...
double RIG_IC7100::get_idd(void)
{
	get_trace(1, "get_idd()");
