...
unsigned long long RIG_IC746::get_vfoA ()
{
...
void RIG_IC746::set_vfoA (unsigned long long freq)
{
	A.freq = freq;
	cmd = pre_to;
	cmd += '\x05';
...
unsigned long long RIG_IC746::get_vfoB ()
{
...
void RIG_IC746::set_vfoB (unsigned long long freq)
{
	B.freq = freq;
	cmd = pre_to;
	cmd += '\x05';
...
const char *RIG_IC746PRO::PRE_label()
{
	switch (preamp_level) {
		case 0: default:
			return "PRE"; break;
...
const char *RIG_IC746PRO::ATT_label()
{
