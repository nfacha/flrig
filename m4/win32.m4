...
if test "x$target_win32" = "xyes"; then
    ...
    AC_DEFINE([__WIN32__], 1, [Define to 1 if we are building on mingw])
...
AC_ARG_WITH([ptw32],
            AS_HELP_STRING([--with-ptw32@<:@=DIR@:>@],[search for pthreads-w32 in DIR/include and DIR/lib @<:@mingw32 only@:>@]),
